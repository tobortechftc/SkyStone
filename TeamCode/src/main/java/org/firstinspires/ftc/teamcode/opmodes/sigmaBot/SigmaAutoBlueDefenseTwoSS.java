 ...
 */
@Autonomous(name="Sigma-Blue-Defense2SS", group="Sigma")
public class SigmaAutoBlueDefenseTwoSS extends LinearOpMode {
...
//        }
        ...
        if (opModeIsActive()) {
            try {
                ...
                int ss_pos = robot.getFirstSkyStoneDefense(StoneLoc, isBlue, isLeft);
