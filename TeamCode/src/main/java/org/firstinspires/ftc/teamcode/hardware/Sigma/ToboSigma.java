...
//        core.yield_for(5);
        ...
        chassis.driveAuto(.7, 140 + 20 * ss_pos, -90 * side, 15000);
...
//        }
        ...
        if (toTake != 6) {
            chassis.driveAuto(.9, (placeSS ? 200 : 140) + 20.32 * (toTake - 3), 0, 15000);
        } else {
            chassis.driveAuto(.9, (placeSS ? 180 : 120) + 20.32 * (toTake - 3), 0, 15000);
        }
